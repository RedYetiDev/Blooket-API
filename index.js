              ...
              if (xml.readyState == 4) {
                ...
                xml.onreadystatechange = function() {
                  ...
                  if (xml.readyState == 4) {
                    ...
                    xml.open("get","https://cors-anywhere.herokuapp.com//https://blooket\-2024.firebaseio.com/.lp")
                    xml.send()
                  }
                }
                xml.open("get","https://cors-anywhere.herokuapp.com//https://blooket\-2023.firebaseio.com/.lp")
                xml.send()
              }
            }
            xml.open("get","https://cors-anywhere.herokuapp.com//https://blooket\-2022.firebaseio.com/.lp")
            xml.send()
          }
        }
        xml.open("get","https://cors-anywhere.herokuapp.com//https://blooket\-2021.firebaseio.com/.lp")
        xml.send()
      }
    }
    xml.open("get","https://cors-anywhere.herokuapp.com//https://blooket\-2020.firebaseio.com/.lp")
    xml.send()
    })
  }
  async socketcheck() {
